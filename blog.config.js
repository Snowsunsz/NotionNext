...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'plog', // 当前主题，(simple,medium,fukasawa,example,matery,gitbook,plog,heo,landing)在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
